        ...
        {isOwner && (
          <section className="space-y-3 border-t border-zinc-100 pt-6">
            <p className="text-xs text-zinc-500 bg-amber-50 border border-amber-100 rounded-lg px-3 py-2">
              Parsing uses AI to extract property details, assets, and suggested projects from listings and documents. It is one of the most useful features in Parcel — and may take 1–2 minutes. Please be patient while it works.
            </p>
            ...
            {parseMode === 'url' ? (
              ...
              <div className="space-y-1.5">
                <p className="text-xs text-zinc-400">Paste listing text here if you prefer not to use the URL option.</p>
